...
const ContactForm: NextPage<Props> = ({}) => {
  ...
  return (
    <div className="flex justify-center">
      <div className="w-full max-w-3xl rounded-lg border border-slate-300 p-5 dark:border-[#434865] lg:p-10">
        <h3 className="mb-8 text-center text-lg text-slate-700 dark:text-[#d3d8e8] md:mb-12 lg:text-2xl">
          I'm here for you, Send a quote for any questions or help.
        </h3>
        <form onSubmit={handleSubmit(onSubmit)}>
          <p className="mb-4">
            <label
              className="text-slate-700 dark:text-[#d3d8e8]"
              htmlFor="email"
            >
              Your email:
            </label>
          ...
          <button
            type="submit"
            className="gradient-btn mt-3 flex items-center gap-1"
          >
